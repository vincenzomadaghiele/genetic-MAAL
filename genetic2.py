...
if __name__ == '__main__': 
	...
	sound_corpus_filepath = './genetic_algorithm2/corpus/sound' # dir where all the sound examples are
	starting_config_filepath = './genetic_algorithm2/corpus/starting_config.json'
	corpus_output_dir_path = './genetic_algorithm2/corpus/decisions_log'
	...
	# GENERAL INITS
	config_files_path = './genetic_algorithm2/config_files'
	best_configs_path = './genetic_algorithm2/best_configs'
	looper_outputs_path = './genetic_algorithm2/looper_outputs'
