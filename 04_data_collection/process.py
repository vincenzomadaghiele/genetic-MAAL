...
if __name__ == '__main__': 
	...
	def cutPerformance(start_time=None, stop_time=None):
		...
		newpath = f'performance/cut_{int(start_time)}-{int(stop_time)}'
		...
		sf.write(f'{newpath}/dry-in_{int(start_time)}-{int(stop_time)}.wav', cut_signal, sr, subtype='PCM_24')
